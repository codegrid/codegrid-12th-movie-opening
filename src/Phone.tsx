...
import { CAMERA_DISTANCE, getPhoneLayout, PHONE_CURVE_SEGMENTS, PHONE_SHININESS } from "./helpers/layout"
  ...
  return (
    <group scale={entranceAnimation} rotation={[0, rotateY, 0]} position={[0, translateY, 0]}>
      ...
      <mesh position={layout.screen.position}>
        ...
        {videoTexture ? <meshBasicMaterial color={0xffffff} toneMapped={false} map={videoTexture} /> : null}
      </mesh>
    </group>
  )
}
